...
return (
    ...
    <div className="area-product">
        ...
        <div className="modal border50" id="adicionar" tabindex="-1" style={{ }} aria-hidden="true">
            ...
            <div className="information_modal">
                    ...
                    <p className="area_color"></p>
                    <Link className="remove_cart"
                    to={`/produtos/${selectedProduct.id}`}
                    style={{ textDecoration: "none", color: "white" }}>
                    <div className="border10 botao_azul" onClick={desaparecermodal}>
                    Continuar comprando
                    </div>
                    </Link>
                    <Link className="add_cart"
                    to={`/checkout/${selectedProduct.id}`}
                    style={{ textDecoration: "none", color: "white" }}>
                    <div className="border10 botao_cinza" >
                    Finalizar compra
                    </div>
                </Link>
            </div>
